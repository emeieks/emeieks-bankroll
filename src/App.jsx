          ...
          <div className="view-enter" style={{paddingBottom:8}}>
            ...
            <div style={{borderRadius:20,overflow:"hidden",marginBottom:14,background:"linear-gradient(160deg,#0d2518 0%,#061810 100%)",border:"1px solid rgba(34,197,94,0.2)"}}>
              ...
              <div style={{padding:"4px 8px 12px"}}>
                <BankrollChart points={chartPoints} h={160}/>
              </div>
            </div>
            ...
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:12}}>
              {[
                ...
                <div key={k.label} style={{background:"#111827",border:"1px solid #1F2937",borderRadius:16,padding:"16px 18px",position:"relative"}}>
                  <div style={{fontSize:9,color:"#6B7280",fontWeight:700,letterSpacing:1.5,textTransform:"uppercase",marginBottom:8}}>{k.label}</div>
