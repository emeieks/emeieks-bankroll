          ...
          return(
            <div key={i} style={{background:"#111827",border:"1px solid #1F2937",borderRadius:14,padding:"13px 14px"}}>
              ...
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr 1fr",gap:6}}>
                {[{label:"Book",val:b.book_line,col:"#E5E7EB"},,col:"#E5E7EB"},{label:"Diff",val:"+"+parseFloat(b.diff||0).toFixed(2),col:"#F59E0B"},{label:"Cote",val:"@"+(b.odds||0),col:"#A78BFA"}].map(({label,val,col})=>(
