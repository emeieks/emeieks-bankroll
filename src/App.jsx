...
const DEFAULT_BK=["Stake","Roobet","Rainbet","BCGame","Duelbits","Duel","Yeet","Thunderpick","Winna","Thrill","Spartans","Gambana","Betpanda","Toshi"];
...
function MesParisView({
  ...
  const {allByDay,allByMonth,allMonthKeys}=useMemo(()=>{
    const allByDay={};
